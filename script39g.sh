...
# Write a bash script 'script.sh' that can be sourced in a loop to count the number of occurence in all files, supposing that word   # count is stored in the variable named 'words'.
