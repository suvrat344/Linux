...
# For example:
# If the variable month contains the string "nov", your solution should create a file named nov.txt containing the calendar of 
# november month and error.txt should be empty.
