...
# The names of the variable which stores the employee Ids are shell variable with names 'eid1','eid2' and 'eid3'.Redirect your outpur# in the same sequence as 'sort -n' order of the shell variable names.
