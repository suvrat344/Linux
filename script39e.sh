...
# Write a bash script 'script.sh' to redirect the "manual" entry (i.e. output of man page) for the command which is specified as     # value of the shell variable named 'cmd' to a text file 'man_commandValue.txt', where 'commandValue' is the value in variable 'cmd' # (example : if the variable 'cmd' has value 'ls',then redirect the output of 'man ls' to the file named 'man_ls.txt').
